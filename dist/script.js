...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_1__["default"])(intervalId);
...
var modals = function modals(modalId) {
  console.log(modalId);
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    var closeModalOver = document.querySelector('.popup_engineer');
    var closeModalOver1 = document.querySelector('.popup');
    modal.addEventListener('click', function (e) {
      if (e.target === closeModalOver || e.target === closeModalOver1) {
        modal.style.display = "none"; // document.body.style.overflow = '';
